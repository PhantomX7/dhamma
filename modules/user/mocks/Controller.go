...
// AssignDomain provides a mock function with given fields: ctx
func (_m *Controller) AssignDomain(ctx *gin.Context) {
	_m.Called(ctx)
}

// Controller_AssignDomain_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AssignDomain'
type Controller_AssignDomain_Call struct {
	*mock.Call
}

// AssignDomain is a helper method to define mock.On call
//   - ctx *gin.Context
func (_e *Controller_Expecter) AssignDomain(ctx interface{}) *Controller_AssignDomain_Call {
	return &Controller_AssignDomain_Call{Call: _e.mock.On("AssignDomain", ctx)}
}

func (_c *Controller_AssignDomain_Call) Run(run func(ctx *gin.Context)) *Controller_AssignDomain_Call {
...
func (_c *Controller_AssignDomain_Call) Return() *Controller_AssignDomain_Call {
	_c.Call.Return()
	return _c
}

func (_c *Controller_AssignDomain_Call) RunAndReturn(run func(*gin.Context)) *Controller_AssignDomain_Call {
	_c.Run(run)
	return _c
}
